...
<%
    List<Car> voitures = (List<Car>) request.getAttribute("voitures");
    List<Car> quantites = (List<Car>) request.getAttribute("quantites");
...
<tr>
    <td><%=c.getMaker()%></td>
    <td><%=c.getModel()%></td>
    <td><%=quantites.get(voitures.indexOf(c)) %></td>
</tr>
<%
    }
%>
